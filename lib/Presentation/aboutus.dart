...
// import 'package:ebon_circuit/Presentation/color.dart';
...
//             color: primaryColor, size: 21, fontWeigth: FontWeight.bold),
//         centerTitle: true,
...
//               SizedBox(height: 16),
//               Text(
//                 'At Ebon Circuit, we believe that shopping should be an experience, not just a transaction. '
...
//               SizedBox(height: 8),
//               Text(
//                 'Ebon Circuit is more than just an eCommerce platform; it’s a community of passionate shoppers, dedicated to discovering the finest and most innovative products available. '
...
//               SizedBox(height: 8),
//               Text(
//                 'We invite you to explore our app and discover the many benefits of shopping with Ebon Circuit. Whether you\'re a tech enthusiast, a fashionista, or someone just looking for a good deal, Ebon Circuit is here to meet your needs. Thank you for choosing us as your preferred shopping destination.',
//                 style: TextStyle(fontSize: 16, height: 1.5),
//               ),
//             ],
//           ),
