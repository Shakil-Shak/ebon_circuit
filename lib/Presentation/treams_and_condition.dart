...
//       appBar: AppBar(
//         title:
//             customText('Terms and Conditions', size: 21, color: primaryColor),
//         centerTitle: true,
...
//               SizedBox(height: 16),
//               Text(
//                 'Welcome to Ebon Circuit. By using our app, you agree to comply with and be bound by the following terms and conditions. Please review these terms carefully.',
...
//               SizedBox(height: 8),
//               Text(
//                 'These Terms and Conditions govern your use of the Ebon Circuit app. By accessing or using the app, you agree to be bound by these terms.',
//                 style: TextStyle(fontSize: 16, height: 1.5),
//               ),
//               SizedBox(height: 24),
//               Text(
